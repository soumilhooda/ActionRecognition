...
class UCF101TEST(Dataset):
    def __init__(self, root = '/home/so079001/Res3D/UCF101_Res3D/Data', train=True, fold=1, transform=None, frames_path='/home/c3-0/datasets/UCF101_frames/frames_256/'):
    ...
    def get_video(self, video_path, start):
        ...
        for item in range(start_frame, start_frame+16):
            image_name = 'frame'+str(item).zfill(6) + '.jpg'
    ...
    def build_paths(self):
        ...
        if self.train:
            for key in annotation_data:
                ...
                start_frames = list(range(1, n_frame, 17))
